...
<nav class="pagination-nav" aria-label="<?php echo __('Pagination'); ?>">
    <ul class="pagination">
        ...
        <li class="pagination_previous">
            ...
            <a rel="prev" href="<?php echo html_escape($this->url(array(), null, $getParams)); ?>"><i class="material-icons">&#xE5CB;</i></a>
        </li>
        <?php endif; ?>
        ...
        <li class="pagination_next">
            ...
            <a rel="next" href="<?php echo html_escape($this->url(array(), null, $getParams)); ?>"><i class="material-icons">&#xE5CC;</i></a>
        </li>
        <?php endif; ?>
    </ul>
</nav>
